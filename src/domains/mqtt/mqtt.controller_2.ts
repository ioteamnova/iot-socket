...
const options = {
  //host: 'mqtts://43.201.185.236:8883',
  host: '43.201.185.236',
	port: 8883,
	protocol: 'mqtts',
  ca: [fs.readFileSync('/etc/mosquitto/CA/ca.crt')],
 ...
 // var senddata = "macbook 온도 제어 데이터 : 3";
  function intervalFunc() {
   //-********-//
    ...
    //client.publish("hello", JSON.stringify(senddata), options);
    //console.log("***test 전송::1")
